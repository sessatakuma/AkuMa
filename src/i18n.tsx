...
const translations: Record<Locale, TranslationSet> = {
    ...
    zh: {
        ...
        heading: 'Accent Marker | 日語重音與振假名工具',
        htmlExportAriaLabel: '重音標註文字匯出',
        htmlExportTitle: 'Accent Marker Export',
        inputAriaLabel: '要分析的日語文字',
        inputDescription:
            '分析結果會顯示在右側結果區域。編輯時可以切換重音，也可以直接修改振假名。',
        inputLabel: '要分析的日語文字',
        inputPanelLabel: '輸入',
        inputPlaceholder: '輸入日語文字...',
        inputTools: '輸入工具',
        pageDescription:
            '貼上日語文字，自動加入振假名與音高重音標記，之後還可編輯並匯出結果。',
        pasteFromClipboard: '從剪貼簿貼上',
        randomSample: '插入範例文字',
        result: '結果',
        resultActions: '結果操作',
        resultHint: '點擊振假名或重音標記即可編輯',
        resultPanelLabel: '結果',
